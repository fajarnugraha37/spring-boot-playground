...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-01-31T12:32').blur().should('have.value', '2023-01-31T12:32');

      cy.get(`[data-cy="endDate"]`).type('2023-01-30T19:30').blur().should('have.value', '2023-01-30T19:30');

      cy.get(`[data-cy="language"]`).select('INDONESIA');
