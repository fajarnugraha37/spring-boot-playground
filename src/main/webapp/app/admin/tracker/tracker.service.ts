...
export default class TrackerService {
  ...
  constructor(private router: VueRouter, private store: Store<AccountStateStorable>, private cookie: any) {
  ...
  private updateCredentials(): void {
    this.rxStomp.configure({
      ...
      connectHeaders: {
        ['X-XSRF-TOKEN']: this.cookie.get('JSESSIONID') || this.cookie.get('XSRF-TOKEN'),
      },
    });
  }
